...
function UserInfo() {
  ...
  return (
    <div
      className={`p-4 bg-bg-card rounded-xl border border-border-primary overflow-hidden transition-all duration-400 ${
    ...
    >
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className={`${
            !isExpanded ? "hover:bg-button-hover" : "bg-button-hover"
          } p-2 border hover:border border-bg-card hover:border-border-primary rounded-full text-xl transition-all duration-150`}
        >
          <IoFilter />
        </button>
      </div>
      ...
      >
        <div className="flex flex-col gap-4 mt-6 capitalize">
          <Link
            href={"#"}
