...
export const Table: React.FC<TableProps> = ({ items, loading, selectedItem, setSelectedItem }) => {
  ...
  const tableHeaders = ["N", "Nivel Remunerativo", "pap", "cnp/cap", "cargo", "Dependencia", "periodo", "Archivo"];
              ...
              <tbody>
                {paginatedItems.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 lg:px-6 py-3">{item.nivel_remunerado}</td>
                    <td className="px-4 lg:px-6 py-3">{item.pap}</td>
