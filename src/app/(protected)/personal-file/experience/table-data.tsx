...
type TableProps = {
  ...
  loading: boolean;
  selectedItem: ExperienceRecord | null;
...
export const Table: React.FC<TableProps> = ({ items, loading, selectedItem, setSelectedItem }) => {
  ...
  const tableHeaders = ["N", "Centro de Labor", "Cargo", "Dependencia", "Periodo", "Archivo"];
              ...
              <tbody>
                {paginatedItems.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 lg:px-6 py-3">{item.centro_labor}</td>
                    <td className="px-4 lg:px-6 py-3">{item.centro_labor}</td>
                    <td className="px-4 lg:px-6 py-3">{item.cargo}</td>
