...
type TableProps = {
  items: ascensoRecord[];
  loading: boolean;
  selectedItem: ascensoRecord | null;
...
export const Table: React.FC<TableProps> = ({ items, loading, selectedItem, setSelectedItem }) => {
  ...
  const tableHeaders = ["N", "Resolución", "CNP", "Nivel Remunerativo", "Fecha", "Cargo Actual", "Nuevo Cargo", "Dependencia Actual", "Nueva Dependencia", "Archivo"];
              ...
              <tbody>
                {paginatedItems.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 lg:px-6 py-3">{item.resolucion_ascenso}</td>
