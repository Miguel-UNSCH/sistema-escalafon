...
import { FormEstudies } from "./FormEstudies";
  ...
  return (
    <div className="flex justify-center w-full h-full">
      <div className="flex flex-col gap-2 w-3/4">
        ...
        {personal?.id ? <FormEstudies personalId={personal.id} /> : <p className="font-inter font-bold text-2xl text-center uppercase">No se pudo obtener el id del personal</p>}
      </div>
    </div>
  );
};
