...
export const getEvaluations = async (id: string): Promise<{ success: boolean; message?: string; data?: evaluationRecord[] }> => {
  try {
...
export const createEvaluation = async (id: string, data: ZEvaluation & { file_id: string }): Promise<{ success: boolean; message: string }> => {
  try {
...
export const updateEvaliation = async (
  id: string,
  user_id: string,
  data: ZEvaluation & { file?: File | null; file_id?: string }
